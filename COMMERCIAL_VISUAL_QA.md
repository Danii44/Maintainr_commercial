...
Live production validation in Arabic RTL confirms the revised header carries only the two commercial calls to action, the hero layout reverses naturally, image panels remain light and readable, and the three-action fixed rail stays legible on desktop and mobile. No Customer portal action or SaaS sign-in control was visible in either published RTL capture.
