...
export default function Shop() {
  ...
  const submit = async (event: React.FormEvent) => {
    ...
    if (!form.customerName.trim() || !form.phone.trim() || !form.address.trim()) { setCheckoutError("Please complete your name, mobile number, and delivery address."); return; }
    setCheckoutError("");
